        ...
        <>
            ...
            >
                <div className="h-full flex flex-col">
                    ...
                    <div className="px-6 py-6 border-b" style={{ borderColor: "#362222" }}>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-400 text-sm mt-1">{totalItems} {totalItems === 1 ? 'item' : 'items'}</p>
                            </div>
                        ...
                        {items.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <button
                                    ...
                                    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = "#9B5555"}
                                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = "#8B4545"}
                                >
                                    Continue Shopping
                                </button>
                            </div>
                            ...
                            <>
                                <div className="space-y-4">
                                    {items.map((item) => (
                                        <div key={item.sku} className="flex gap-4 border-b pb-4" style={{ borderColor: "#362222" }}>
                                            {/* Image */}
                    ...
                    {/* Footer */}
                    {items.length > 0 && (
                        <div className="px-6 py-6 border-t space-y-4" style={{ borderColor: "#362222" }}>
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto px-6 py-6">
                        {items.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {items.map((item) => (
                                    <div key={item.sku} className="flex gap-3 border-b pb-4" style={{ borderColor: "#362222" }}>
                    ...
                    {items.length > 0 && (
                        <div className="px-6 py-4 border-t space-y-3" style={{ borderColor: "#362222" }}>
