...
export default function CheckoutPage() {
    ...
    const handleExpiryChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (year.length === 2) {
            ...
            if (isNaN(y) || y < 0) year = '00';
            else if (y > 99) year = '99';
            else year = y.toString().padStart(2, '0');
        }
    ...
    if (items.length === 0 && !isSuccess) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center" style={{ backgroundColor: '#171010' }}>
                <h1 className="text-4xl font-black text-white mb-4 tracking-tighter">CART IS EMPTY</h1>
                <p className="text-gray-400 mb-8 font-mono">Add some materials before proceeding.</p>
                <Link
                    href="/shop"
    ...
    if (isSuccess) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ backgroundColor: '#171010' }}>
                <div className="max-w-lg w-full border border-[#362222] p-12 text-center bg-[#1a1a1a]">
                    ...
                    <h1 className="text-3xl md:text-4xl font-black text-white mb-2 tracking-tighter uppercase">Order Confirmed</h1>
                    <p className="text-gray-500 font-mono text-sm mb-8 uppercase tracking-widest">
                        Order #{Math.floor(Math.random() * 100000)}-IND
                    </p>

                    <p className="text-gray-300 mb-8 leading-relaxed">
                        Your requisition has been processed. Construction materials will be dispatched to <span className="text-white font-bold">{formData.address}</span> shortly.
                    </p>
                        ...
                        <form id="checkout-form" onSubmit={handleSubmit}>
                            ...
                            <section className="mb-16">
                                <h2 className="text-xl font-black uppercase tracking-widest text-white mb-8 flex items-center gap-4">
                                    <span className="flex items-center justify-center w-8 h-8 border border-[#362222] text-[#8B4513] text-sm">01</span>
                                    Contact Info
                                </h2>
                            ...
                            <section className="mb-16">
                                <h2 className="text-xl font-black uppercase tracking-widest text-white mb-8 flex items-center gap-4">
                                    <span className="flex items-center justify-center w-8 h-8 border border-[#362222] text-[#8B4513] text-sm">02</span>
                                    Shipping Details
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">ZIP / Postal Code</label>
                                        <input
                                            required
                                            type="text"
                                            name="zip"
                            ...
                            <section>
                                <h2 className="text-xl font-black uppercase tracking-widest text-white mb-8 flex items-center gap-4">
                                    <span className="flex items-center justify-center w-8 h-8 border border-[#362222] text-[#8B4513] text-sm">03</span>
                                    Payment Method
                                </h2>
                                ...
                                <div className="bg-[#201a1a] border border-[#362222] p-6 mb-6 relative overflow-hidden group">
                                    <div className="absolute top-0 right-0 p-4 opacity-10">
                                        <svg className="w-32 h-32 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z" /></svg>
                                    </div>
                                    <div className="relative z-10">
                                        <div className="flex justify-between items-start mb-8">
                                            <span className="font-mono text-xs text-gray-500 uppercase tracking-widest">Credit Card</span>
                                        ...
                                        <div className="flex gap-8">
                                            <div className="flex-1">
                                                <label className="block text-[10px] text-gray-500 uppercase tracking-widest mb-1">Expiry</label>
                                                <input
                                                    type="text"
                                                    placeholder="MM/YY"
                                                    name="expiry"
                                            ...
                                            <div>
                                                <label className="block text-[10px] text-gray-500 uppercase tracking-widest mb-1">CVC</label>
                                                <input
                                                    type="text"
                                                    placeholder="123"
                                                    name="cvc"
                            ...
                            <div className="border border-[#362222] bg-[#1a1a1a] p-8">
                                ...
                                <div className="space-y-6 mb-8 max-h-[400px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-[#362222] scrollbar-track-transparent">
                                    {items.map((item) => (
                                        <div key={item.sku} className="flex gap-4 group">
                                            <div className="w-16 h-20 relative bg-[#201a1a] border border-[#362222] flex-shrink-0">
                                                {item.image ? (
                                            ...
                                            <div className="flex-1">
                                                <div className="flex justify-between items-start">
                                                    <h4 className="text-white font-bold text-sm uppercase tracking-wide leading-tight">{item.name}</h4>
                                                    <span className="text-gray-400 font-mono text-xs ml-2">x{item.quantity}</span>
                                                </div>
                                ...
                                <div className="space-y-3 border-t border-[#362222] pt-6 mb-8">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-gray-300 font-mono">${totalPrice.toFixed(2)}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-400 uppercase tracking-wider">Taxes</span>
                                        <span className="text-gray-300 font-mono">$0.00</span>
                                    </div>
                                </div>
